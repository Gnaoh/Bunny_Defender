...
BunnyDefender.Preloader.prototype = {
	...
	preload: function () {
		this.preloadBar = this.add.sprite(this.world.centerX, this.world.centerY, 'preloaderBar'); //crops preloader sprites // gameword center points
		this.preloadBar.anchor.setTo(0.5, 0.5);
		this.load.setPreloadSprite(this.preloadBar); //assign preload sprite to preloadBar
